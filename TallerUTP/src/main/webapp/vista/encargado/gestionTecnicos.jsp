	      ...
	      <div class="modal-body">
				...
				<form  class="formulario" >
			        ...
			        <div class="form__contenedor">
			            ...
			            <div class="form__grupo">
			                <input type="text" class="form__input" placeholder=" " value="${tec.getNroDocumento()}">
			           ...
			           <select class="form__seleccion" name="distrito">
			            ...
			            <div class="form__grupo" align="center">
			                <input type="number" class="form__input" placeholder=" " value="${tec.getAniosExperiencia()}">
			        ...
			        <div class="row align-items-center pt-4">
				      	<div class="form__grupo col-12">
			                <input class="btn__insertar" type="submit" value="MODIFICAR">           
			            </div>
			        </div>
			    </form>
