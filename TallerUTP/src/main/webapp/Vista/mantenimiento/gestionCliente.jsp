...
<head>
	...
	<link rel="stylesheet" href="./css/mant.css" type="text/css">
...
<body>
	<div class="d-flex justify-content-center">
		...
		<div class="col-sm-8 contenido paddingsty">
			<table id="miTabla" class="tabla__titulo" >
				...
				<tr>
					...
					<td class="td__acciones">
						  <button class="fa-solid fa-pen icono" data-bs-toggle="modal" data-bs-target="#staticBackdrop"></button>
