			...
			<div class="card-body">
				<form class="justify-content-center needs-validation"  align="center" action="Validar" novalidate>
					...
					<div class="form-group pt-2">
						...
						<input type="text" name="txt_nomTec" class="form-control estinputs" placeholder="Nombres" required>
					...
					<div class="form-group pt-1">
						...
						<input type="text" class="form-control estinputs" name="txt_ape1Tec" placeholder="Principal" required>
						<div class="valid-feedback">Campos Completos</div>
						<div class="invalid-feedback">Campos Incompletos</div>
						</div>
						<div style="float:right; width: 160px;">
						<input type="text" class="form-control estinputs" name="txt_ape2Tec" placeholder="Secundario" required>
						<div class="valid-feedback">Campos Completos</div>
						<div class="invalid-feedback">Campos Incompletos</div>
						</div>
					...
					<div class="form-group pt-2">
						...
						<input type="email" name="txt_email" class="form-control estinputs" placeholder="Correo Electronico" required>
						<div class="valid-feedback">Campos Completos</div>
						<div class="invalid-feedback">Campos Incompletos</div>
					</div>
					...
					<div class="form-group pt-1">
						<input id="phone" type="number" name="txt_telefTec" class="form-control estinputs" required>
						<div class="valid-feedback">Campos Completos</div>
						<div class="invalid-feedback">Campos Incompletos</div>
					</div>
