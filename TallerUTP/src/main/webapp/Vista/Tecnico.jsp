...
<%@ page import="java.util.List" %>
	...
	<div class="d-flex justify-content-center">
		...
		<%
			...
			List<Tecnico> lst = daotec.listar();
		%>
		<div class="col-sm-8 paddingsty" id="formServPrest">
			<table id="miTabla" class="table table-dark table-hover text-center">
				...
				%>
				<tr>
					<th><%=tec.getIdTecnico()%></th>
					<th><%=tec.getNombre() %></th>
					<th><%=tec.getApePrin()+"/"+tec.getApeSec()%></th>
					<th><%=tec.getNro_doc() %></th>
					<th><%=tec.getDireccion()%></th>
					<th><%=tec.getEmail()%></th>
					<th><%=tec.getAnios_experiencia()%></th>
				</tr>
				<%
					} 
				%>		
